...
class UIandFunction:
    ...
    def frameTop(self, root, Basecolor):
        ...
        lb_table1 = Label(frameleft, text="List Pelanggan Urut Terakhir Keluar", bg=Basecolor, fg="black")
        ...
        lb_title_bayar = Label(frameright, text="Biaya Parkir Per Jam", fg="black", bg=Basecolor)
        lb_title_bayar.config(font=("Helvetica", 12, BOLD))
        lb_title_bayar.place(x=0, y=70)
        lb_bayar = Label(frameright, text="Rp 2.000", fg="Black", bg=Basecolor)
        lb_bayar.config(font=("Helvetica", 42, BOLD))
        lb_bayar.place(x=0, y=90)
        lb_table2 = Label(frameright, text="List Pelanggan Banyak Bayar", bg=Basecolor, fg="black")
        lb_table2.config(font=("Arial", 12, BOLD))
...
if __name__ == "__main__":
    Basecolor = '#%02x%02x%02x' % (60, 35, 190)
    root = Tk()
