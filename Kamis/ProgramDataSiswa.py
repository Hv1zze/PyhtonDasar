...
canvas=tk.Canvas(window,bg="Navy")
canvas.pack(fill="both",expand=True)

judulFont=("Consolas",20,"bold")
judul=tk.Label(canvas, text="DATA SISWA BARU",font=judulFont,bg="Navy")
...
alamatEntry=ttk.Entry(inputFrame, width=75)
alamatEntry.grid(row=15,column=0)

hapus=tk.Button(canvas, text="Hapus",bg="white")
hapus.grid(row=2,column=0,padx=115,sticky="W")

simpan=tk.Button(canvas, text="Simpan",bg="white")
